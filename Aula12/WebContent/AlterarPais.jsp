                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="populacao" id="populacao" placeholder="População" value="${pais.populacao}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Área</label>
                                <input type="text" class="form-control" name="area" id="area" placeholder="Área" value="${pais.area}">
                            </div>
                        </div>
                        <hr />
